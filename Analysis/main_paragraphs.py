...
def make_trials_from_datafile(input_path):
    ...
    for idx in range(0, 3):
        start_time    = float(main_df.iloc[[message_idx[2 * idx - 6]]].iloc[0, 1])
        ...
        trial_message = main_df.iloc[[message_idx[2 * idx - 6]]].iloc[0, 2]
...
if __name__ == "__main__":
    dataPath = '/Users/amirali/Desktop/Amirali/NBIC/Dehghan/Data/Paragraphs'
    ...
    for sub in subDataPath:
        ...
        for csv in subCSVFiles:
            if csv == 'datafile_56.csv' or csv == 'datafile_6.csv' or csv == 'datafile_46.csv' or csv == 'datafile_456.csv':
                selected = csv
            else:
                continue
